...
# [FIX] z NEGATIVO (-0.12): o escudo vai pra parte EXTERNA da mão (lado de fora), não pra frente do grip.
# Tuning: x=mover de lado · y=ao longo da mão (cima/baixo) · z=externo(−)/frente(+). [ESCUDO_MAO]
