...
> Números (níveis, andares) são placeholders de design — balanceamento depois.

## A frase
Você é mandado pelo **Velho Mundo** para **salvar** o Rei do novo continente — e descobre que terá que **matá-lo**. Pior: matá-lo é exatamente o que o verdadeiro inimigo queria. O "resgate" foi a isca.
...
- **O Deus que Dorme** — uma entidade primordial que jaz **sob** o continente novo. Não foi selada por ninguém; ela simplesmente **dorme**. Mas é tão imensa que, mesmo adormecida, **vaza**:
  ...
  - a **mente** dela vaza e adoece o pensamento humano — é isso que chamam de **magia**. `[magia/Mage]` Por isso a humanidade "ainda não sabe magia": não é um ofício, é uma **doença** do Deus tocando a mente. O `INT` fica reservado, e um futuro **Mage** será quem aprende a **beber sem se afogar**.
  - a **vontade** dela alcança até as **águas do oceano**.
...
- Ironia central: um **pescador — fisgado**.
...
## Temporada 1 — a história (linha do tempo)
...
## Ganchos com as mecânicas (a lore explica o jogo)

- **A isca, em camadas (motivo central):** o Deus fisga um *pescador* → usa as *riquezas* pra fisgar um *rei* → usa o *socorro* pra fisgar os *heróis*. Você é sempre o peixe.
- **Magia / Mage `[REBALANCE]`:** magia = a mente do Deus adoecendo humanos; `INT` reservado; Mage futuro = o primeiro a usar sem virar trevas.
- **Classes & Trial `[CLASSES]`:** **Guerreiro/Arqueiro** = soldados que a Velha Coroa mandou; **Mercador** = o **explorador ganancioso** que veio pelas riquezas (machado/marreta = guarda de caravana). O **Trial no Lv10** = provar seu caminho antes de encarar a Torre a sério (os Guardiões = veteranos/sentinelas da Velha Coroa).
- **PvP / guildas / guerra `[GUERRA_FORMACAO]`:** o continente é rico e a corrupção apodrece quem fica perto — facções disputam território, aventureiros se saqueiam nas zonas de risco, a arena é o "esporte" da cidade.
- **Reinos / territórios:**
  - **Pesca / Mar Abençoado** → onde a isca é mais literal (o Deus controla as águas; ruínas e peixes que não deviam existir).
  - **Mineração** → cavaram **fundo demais**; veios que **sangram**, túneis que zumbem.
  - **Fortaleza Maldita (COMBAT)** → a **frente** da corrupção, mais perto do que dorme; o chefe errante que "escapou da Torre" = vazamento.
- **Mercador Azul `[MERCADO_STEAM]`:** um mercador de **além-mar/além-véu** que leva seus bens aos "mercados do velho mundo e além" (= Steam). O azul = de fora deste continente.

### A isca do 1º andar (texto que só faz sentido depois da S2)
> *"O primeiro salão é frio demais para um lugar tão alto. O ar não desce das janelas — sobe, de alguma fenda no piso, com cheiro de maré e de terra funda. Há uma marca redonda no chão que ninguém se lembra de ter feito. O Rei mandou cobri-la. Foi a primeira ordem dele."*

(Vai na descrição do **andar 1** da Torre.)
